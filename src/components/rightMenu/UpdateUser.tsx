...
const UpdateUser = ({ user }: { user: User }) => {
  ...
  return (
    <div>
      ...
      {open && (
        <div className="fixed w-screen h-screen top-0 left-0 right-0 bottom-0 overflow-auto overscroll-contain bg-black bg-opacity-65 flex justify-center items-center z-50">
          <form
            action={handleSubmit}
            className="relative p-12 m-12 bg-white rounded-lg shadow-md w-full md:w-1/2 xl:w-1/3 overflow-auto overscroll-contain flex flex-col gap-4"
          >
            {/* Title */}
